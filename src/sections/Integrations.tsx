    ...
    <section id="integrations" className="py-24 overflow-hidden">
      <div className="container">
        <div className="grid items-center lg:grid-cols-2 lg:gap-16">
          ...
          <div>
            <div className="lg:mt-0 mt-8 grid h-[400px] lg:h-[800px] gap-4 overflow-hidden md:grid-cols-2 [mask-image:linear-gradient(to_bottom,transparent,black_10%,black_90%,transparent)]">
